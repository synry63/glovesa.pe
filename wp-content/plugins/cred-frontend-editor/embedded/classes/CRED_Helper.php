...
// Inline Settings/Localization
    ...
    public static function accessNotActiveFormAlertNotice() {
        ?><div class="cred-notification cred-error" style="margin-right:15px;">
            ...
            <p>
                <?php printf(__('This Form will be accessible to everyone, including guest (not logged in). They will be able to submit/edit content using this form.<br>To control who can use the form, please install %s', 'wp-cred'), '<a target="_blank" href="https://wp-types.com/home/types-access/">Access plugin</a>'); ?>
                <?php
