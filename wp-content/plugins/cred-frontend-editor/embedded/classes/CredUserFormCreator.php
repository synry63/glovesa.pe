...
if (!class_exists("CredUserFormCreator", false)) {
    ...
    class CredUserFormCreator {
         ...
         */
        public static function cred_create_form($name, $mode/* new/edit */, $user_type = array('subscriber'), $autogenerate_un = true, $autogenerate_p = true, $autogenerate_nn = true, $post_type = 'user') {
            ...
            if (empty(self::$_created) && !in_array($name, self::$_created)) {
                ...
                $autogenerate = array('username' => $autogenerate_un,
                    'nickname' => $autogenerate_nn,
                    'password' => $autogenerate_p);
                $fields_all = $fields_model->getFields($autogenerate);
...
//                if ($autogenerate_un) {
//                    unset($fields_all['form_fields']['user_login']);
//                }
//                if ($autogenerate_nn) {
//                    unset($fields_all['form_fields']['nickname']);
//                }
//                if ($autogenerate_p) {
//                    unset($fields_all['form_fields']['user_pass']);
//                    unset($fields_all['form_fields']['user_pass2']);
//                }
...
//                }
                ...
                $fields['form_settings']->autogenerate_username_scaffold = $autogenerate_un;
                $fields['form_settings']->autogenerate_password_scaffold = $autogenerate_p;
