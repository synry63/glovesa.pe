...
function cred_delete_post_link($post_id = false, $text = '', $action = '', $class = '', $style = '', $message = '', $message_after = '', $message_show = 1, $return = false) {
...
//https://onthegosystems.myjetbrains.com/youtrack/issue/refsites-175
function cred_translate($name, $string, $context = 'CRED_CRED') {
    if (!function_exists('icl_t'))
        return $string;
